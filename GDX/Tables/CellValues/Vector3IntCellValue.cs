...
{
    /// <summary>
    ///     A <see cref="TableBase"/> <see cref="Vector3Int"/> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public Vector3IntCellValue(TableBase table, int rowIdentifier, int columnIdentifier)
        {
            Table = table;
        ...
        /// <summary>
        ///     Get the <see cref="Vector3Int" /> value referenced from the <see cref="TableBase" />.
        /// </summary>
        /// <remarks>
        ...
        public Vector3Int Get()
        {
            ...
            m_CachedValue = Table.GetVector3Int(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(Vector3Int newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = Table.SetVector3Int(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
