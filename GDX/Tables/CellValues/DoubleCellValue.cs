...
{
    /// <summary>
    ///     A <see cref="TableBase" /> <see cref="double" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public DoubleCellValue(TableBase table, int rowIdentifier, int columnIdentifier)
        {
            Table = table;
        ...
        /// <summary>
        ///     Get the <see cref="double" /> value referenced from the <see cref="TableBase" />.
        /// </summary>
        /// <remarks>
        ...
        public double Get()
        {
            ...
            m_CachedValue = Table.GetDouble(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(double newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = Table.SetDouble(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
