...
{
    /// <summary>
    ///     A <see cref="TableBase"/> <see cref="long"/> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public LongCellValue(TableBase table, int rowIdentifier, int columnIdentifier)
        {
            Table = table;
        ...
        /// <summary>
        ///     Get the <see cref="long" /> value referenced from the <see cref="TableBase" />.
        /// </summary>
        /// <remarks>
        ...
        public long Get()
        {
            ...
            m_CachedValue = Table.GetInt(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(long newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = Table.SetLong(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
