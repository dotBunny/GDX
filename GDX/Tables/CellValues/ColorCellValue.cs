...
{
    /// <summary>
    ///     A <see cref="TableBase"/> <see cref="Color"/> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public ColorCellValue(TableBase table, int rowIdentifier, int columnIdentifier)
        {
            Table = table;
        ...
        /// <summary>
        ///     Get the <see cref="Color" /> value referenced from the <see cref="TableBase" />.
        /// </summary>
        /// <remarks>
        ...
        public Color Get()
        {
            ...
            m_CachedValue = Table.GetColor(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(Color newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = Table.SetColor(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
