...
{
    /// <summary>
    ///     A <see cref="TableBase"/> <see cref="Hash128"/> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public Hash128CellValue(TableBase table, int rowIdentifier, int columnIdentifier)
        {
            Table = table;
        ...
        /// <summary>
        ///     Get the <see cref="Hash128" /> value referenced from the <see cref="TableBase" />.
        /// </summary>
        /// <remarks>
        ...
        public Hash128 Get()
        {
            ...
            m_CachedValue = Table.GetHash128(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(Hash128 newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = Table.SetHash128(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
