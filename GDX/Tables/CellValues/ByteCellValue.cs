...
{
    /// <summary>
    ///     A <see cref="TableBase"/> <see cref="byte"/> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public ByteCellValue(TableBase table, int rowIdentifier, int columnIdentifier)
        {
            Table = table;
        ...
        /// <summary>
        ///     Get the <see cref="byte" /> value referenced from the <see cref="TableBase" />.
        /// </summary>
        /// <remarks>
        ...
        public byte Get()
        {
            ...
            m_CachedValue = Table.GetByte(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(byte newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = Table.SetByte(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
