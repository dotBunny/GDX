...
{
    /// <summary>
    ///     A <see cref="TableBase"/> <see cref="BoundsInt"/> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public BoundsIntCellValue(TableBase table, int rowIdentifier, int columnIdentifier)
        {
            Table = table;
        ...
        /// <summary>
        ///     Get the <see cref="BoundsInt" /> value referenced from the <see cref="TableBase" />.
        /// </summary>
        /// <remarks>
        ...
        public BoundsInt Get()
        {
            ...
            m_CachedValue = Table.GetBoundsInt(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(BoundsInt newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = Table.SetBoundsInt(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
