...
{
    /// <summary>
    ///     A <see cref="TableBase" /> <see cref="Vector4" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public Vector4CellValue(TableBase table, int rowIdentifier, int columnIdentifier)
        {
            Table = table;
        ...
        /// <summary>
        ///     Get the <see cref="Vector4" /> value referenced from the <see cref="TableBase" />.
        /// </summary>
        /// <remarks>
        ...
        public Vector4 Get()
        {
            ...
            m_CachedValue = Table.GetVector4(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(Vector4 newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = Table.SetVector4(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
