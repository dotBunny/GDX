...
namespace GDX.Tables.CellValues
{
    public struct LayerMaskCellValue
    {
        ...
        public LayerMaskCellValue(ITable table, int rowID, int columnID)
        {
            Table = table;
            RowID = rowID;
            ColumnID = columnID;
        ...
        public LayerMask Get()
        {
            ...
            {
                m_CachedValue = Table.GetLayerMask(RowID, ColumnID);
        ...
        public void Set(LayerMask value, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = Table.SetLayerMask(RowID, ColumnID, value);
            }
        }
    }
}