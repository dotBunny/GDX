...
{
    /// <summary>
    ///     A <see cref="TableBase"/> <see cref="LayerMask"/> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public LayerMaskCellValue(TableBase table, int rowIdentifier, int columnIdentifier)
        {
            Table = table;
        ...
        /// <summary>
        ///     Get the <see cref="LayerMask" /> value referenced from the <see cref="TableBase" />.
        /// </summary>
        /// <remarks>
        ...
        public LayerMask Get()
        {
            ...
            m_CachedValue = Table.GetLayerMask(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(LayerMask newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = Table.SetLayerMask(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
