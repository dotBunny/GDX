...
{
    /// <summary>
    ///     A <see cref="TableBase"/> <see cref="RectInt"/> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public RectIntCellValue(TableBase table, int rowIdentifier, int columnIdentifier)
        {
            Table = table;
        ...
        /// <summary>
        ///     Get the <see cref="RectInt" /> value referenced from the <see cref="TableBase" />.
        /// </summary>
        /// <remarks>
        ...
        public RectInt Get()
        {
            ...
            {
                m_CachedValue = Table.GetRectInt(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(RectInt newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = Table.SetRectInt(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
