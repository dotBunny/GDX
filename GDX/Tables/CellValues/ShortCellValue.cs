...
{
    /// <summary>
    ///     A <see cref="TableBase"/> <see cref="short"/> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        public ShortCellValue(TableBase table, int rowIdentifier, int columnIdentifier)
        {
            Table = table;
        ...
        /// <summary>
        ///     Get the <see cref="short" /> value referenced from the <see cref="TableBase" />.
        /// </summary>
        /// <remarks>
        ...
        public short Get()
        {
            ...
            m_CachedValue = Table.GetShort(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(short newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = Table.SetShort(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
