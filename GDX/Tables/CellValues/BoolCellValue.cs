...
{
    /// <summary>
    ///     A <see cref="TableBase"/> <see cref="bool"/> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public BoolCellValue(TableBase table, int rowIdentifier, int columnIdentifier)
        {
            Table = table;
        ...
        /// <summary>
        ///     Get the <see cref="bool" /> value referenced from the <see cref="TableBase" />.
        /// </summary>
        /// <remarks>
        ...
        public bool Get()
        {
            ...
            m_CachedValue = Table.GetBool(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(bool newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = Table.SetBool(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
