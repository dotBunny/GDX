...
{
    /// <summary>
    ///     A <see cref="TableBase"/> <see cref="ulong"/> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public ULongCellValue(TableBase table, int rowIdentifier, int columnIdentifier)
        {
            Table = table;
        ...
        /// <summary>
        ///     Get the <see cref="ulong" /> value referenced from the <see cref="TableBase" />.
        /// </summary>
        /// <remarks>
        ...
        public ulong Get()
        {
            ...
            m_CachedValue = Table.GetULong(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(ulong newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = Table.SetULong(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
