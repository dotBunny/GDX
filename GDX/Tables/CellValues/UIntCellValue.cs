...
{
    /// <summary>
    ///     A <see cref="TableBase"/> <see cref="uint"/> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public UIntCellValue(TableBase table, int rowIdentifier, int columnIdentifier)
        {
            Table = table;
        ...
        /// <summary>
        ///     Get the <see cref="uint" /> value referenced from the <see cref="TableBase" />.
        /// </summary>
        /// <remarks>
        ...
        public uint Get()
        {
            ...
            m_CachedValue = Table.GetUInt(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(uint newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = Table.SetUInt(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
