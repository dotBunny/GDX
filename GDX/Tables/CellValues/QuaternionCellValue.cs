...
{
    /// <summary>
    ///     A <see cref="TableBase"/> <see cref="Quaternion"/> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public QuaternionCellValue(TableBase table, int rowIdentifier, int columnIdentifier)
        {
            Table = table;
        ...
        /// <summary>
        ///     Get the <see cref="Quaternion" /> value referenced from the <see cref="TableBase" />.
        /// </summary>
        /// <remarks>
        ...
        public Quaternion Get()
        {
            ...
            m_CachedValue = Table.GetQuaternion(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(Quaternion newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = Table.SetQuaternion(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
