...
{
    /// <summary>
    ///     A <see cref="TableBase" /> <see cref="AnimationCurve" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public AnimationCurveCellValue(TableBase table, int rowIdentifier, int columnIdentifier)
        {
            Table = table;
        ...
        /// <summary>
        ///     Get the <see cref="AnimationCurve" /> object referenced from the <see cref="TableBase" />.
        /// </summary>
        /// <remarks>
        ...
        public AnimationCurve Get()
        {
            ...
            m_CachedValue = Table.GetAnimationCurve(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(AnimationCurve newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = Table.SetAnimationCurve(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
