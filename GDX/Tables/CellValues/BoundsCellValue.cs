...
{
    /// <summary>
    ///     A <see cref="TableBase"/> <see cref="Bounds"/> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public BoundsCellValue(TableBase table, int rowIdentifier, int columnIdentifier)
        {
            Table = table;
        ...
        /// <summary>
        ///     Get the <see cref="Bounds" /> value referenced from the <see cref="TableBase" />.
        /// </summary>
        /// <remarks>
        ...
        public Bounds Get()
        {
            ...
            m_CachedValue = Table.GetBounds(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(Bounds newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = Table.SetBounds(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
