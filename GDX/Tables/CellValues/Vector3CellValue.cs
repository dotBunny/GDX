...
{
    /// <summary>
    ///     A <see cref="TableBase"/> <see cref="Vector3"/> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public Vector3CellValue(TableBase table, int rowIdentifier, int columnIdentifier)
        {
            Table = table;
        ...
        /// <summary>
        ///     Get the <see cref="Vector3" /> value referenced from the <see cref="TableBase" />.
        /// </summary>
        /// <remarks>
        ...
        public Vector3 Get()
        {
            ...
            m_CachedValue = Table.GetVector3(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(Vector3 newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = Table.SetVector3(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
