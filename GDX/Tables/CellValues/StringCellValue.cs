...
{
    /// <summary>
    ///     A <see cref="TableBase"/> <see cref="string"/> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public StringCellValue(TableBase table, int rowIdentifier, int columnIdentifier)
        {
            Table = table;
        ...
        /// <summary>
        ///     Get the <see cref="string" /> value referenced from the <see cref="TableBase" />.
        /// </summary>
        /// <remarks>
        ...
        public string Get()
        {
            ...
            m_CachedValue = Table.GetString(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(string newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = Table.SetString(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
