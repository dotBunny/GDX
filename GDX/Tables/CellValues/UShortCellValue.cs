...
{
    /// <summary>
    ///     A <see cref="TableBase"/> <see cref="ushort"/> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public UShortCellValue(TableBase table, int rowIdentifier, int columnIdentifier)
        {
            Table = table;
        ...
        /// <summary>
        ///     Get the <see cref="ushort" /> value referenced from the <see cref="TableBase" />.
        /// </summary>
        /// <remarks>
        ...
        public ushort Get()
        {
            ...
            m_CachedValue = Table.GetUShort(RowIdentifier, ColumnIdentifier);
        ...
        /// <param name="newValue">A <see cref="ushort" /> value.</param>
        /// <param name="updateTable">Should the value be pushed back to the referenced <see cref="TableBase" /> cell?</param>
        public void Set(ushort newValue, bool updateTable = true)
        {
            m_CachedValue = newValue;
            if (updateTable)
            {
                m_TableVersion = Table.SetUShort(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
