...
{
    /// <summary>
    ///     A <see cref="TableBase"/> <see cref="float"/> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public FloatCellValue(TableBase table, int rowIdentifier, int columnIdentifier)
        {
            Table = table;
        ...
        /// <summary>
        ///     Get the <see cref="float" /> value referenced from the <see cref="TableBase" />.
        /// </summary>
        /// <remarks>
        ...
        public float Get()
        {
            ...
            m_CachedValue = Table.GetFloat(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(float newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = Table.SetFloat(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
        ...
        {
            return Serializable.SerializableTypes.Float;
        }
    }
}