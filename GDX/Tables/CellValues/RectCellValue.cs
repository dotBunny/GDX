...
{
    /// <summary>
    ///     A <see cref="TableBase"/> <see cref="Rect"/> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public RectCellValue(TableBase table, int rowIdentifier, int columnIdentifier)
        {
            Table = table;
        ...
        /// <summary>
        ///     Get the <see cref="Rect" /> value referenced from the <see cref="TableBase" />.
        /// </summary>
        /// <remarks>
        ...
        public Rect Get()
        {
            ...
            m_CachedValue = Table.GetRect(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(Rect newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = Table.SetRect(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
