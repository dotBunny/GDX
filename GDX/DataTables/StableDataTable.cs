...
#pragma warning restore IDE1006
        ...
        public override void RemoveRow(int rowIdentifier)
        {
            ...
            DeleteRowsOfTypeInternal(ref m_AllStringColumns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllBoolColumns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllCharColumns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllSByteColumns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllByteColumns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllShortColumns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllUShortColumns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllIntColumns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllUIntColumns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllLongColumns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllULongColumns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllFloatColumns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllDoubleColumns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllVector2Columns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllVector3Columns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllVector4Columns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllVector2IntColumns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllVector3IntColumns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllQuaternionColumns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllRectColumns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllRectIntColumns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllColorColumns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllLayerMaskColumns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllBoundsColumns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllBoundsIntColumns, rowDenseIndex, 1);
            DeleteRowsOfTypeInternal(ref m_AllHash128Columns, rowDenseIndex, 1);
