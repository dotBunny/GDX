...
{
    /// <summary>
    ///     A <see cref="DataTableObject" /> <see cref="int" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        /// <summary>
        ///     Creates an <see cref="IntCellValue" />.
        /// </summary>
        ...
        public IntCellValue(DataTableObject dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="int" /> value referenced from the <see cref="DataTableObject" />.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="newValue">An <see cref="int" /> value.</param>
        ...
        public void Set(int newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = DataTable.SetInt(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
