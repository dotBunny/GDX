...
{
    /// <summary>
    ///     A <see cref="DataTableObject" /> <see cref="ulong" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        /// <summary>
        ///     Creates a <see cref="ULongCellValue" />.
        /// </summary>
        ...
        public ULongCellValue(DataTableObject dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="ulong" /> value referenced from the <see cref="DataTableObject" />.
        /// </summary>
        /// <remarks>
        ...
        public ulong Get()
        {
            ...
            m_CachedValue = DataTable.GetULong(RowIdentifier, ColumnIdentifier);
        ...
        /// <param name="newValue">A <see cref="ulong" /> value.</param>
        /// <param name="updateTable">Should the value be pushed back to the referenced <see cref="DataTableObject" /> cell?</param>
        public void Set(ulong newValue, bool updateTable = true)
        {
            m_CachedValue = newValue;
            if (updateTable)
            {
                m_TableVersion = DataTable.SetULong(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
