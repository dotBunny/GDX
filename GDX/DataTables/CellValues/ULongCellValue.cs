...
{
    /// <summary>
    ///     A <see cref="DataTableBase" /> <see cref="ulong" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public ULongCellValue(DataTableBase dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="ulong" /> value referenced from the <see cref="DataTableBase" />.
        /// </summary>
        /// <remarks>
