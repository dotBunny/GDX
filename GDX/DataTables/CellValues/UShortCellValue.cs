...
{
    /// <summary>
    ///     A <see cref="DataTableObject" /> <see cref="ushort" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        /// <summary>
        ///     Get the <see cref="ushort" /> value referenced from the <see cref="DataTableObject" />.
        /// </summary>
        /// <remarks>
        ...
        public ushort Get()
        {
            ...
            m_CachedValue = DataTable.GetUShort(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(ushort newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = DataTable.SetUShort(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
