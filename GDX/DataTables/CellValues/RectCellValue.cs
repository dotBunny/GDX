...
{
    /// <summary>
    ///     A <see cref="DataTableObject" /> <see cref="Rect" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        /// <summary>
        ///     Creates a <see cref="RectCellValue" />.
        /// </summary>
        ...
        public RectCellValue(DataTableObject dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="Rect" /> value referenced from the <see cref="DataTableObject" />.
        /// </summary>
        /// <remarks>
        ...
        public Rect Get()
        {
            ...
            m_CachedValue = DataTable.GetRect(RowIdentifier, ColumnIdentifier);
        ...
        /// <param name="newValue">A <see cref="Rect" /> struct.</param>
        /// <param name="updateTable">Should the value be pushed back to the referenced <see cref="DataTableObject" /> cell?</param>
        public void Set(Rect newValue, bool updateTable = true)
        {
            m_CachedValue = newValue;
            if (updateTable)
            {
                m_TableVersion = DataTable.SetRect(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
