...
{
    /// <summary>
    ///     A <see cref="DataTableBase" /> <see cref="AnimationCurve" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        /// <summary>
        ///     Creates an <see cref="AnimationCurveCellValue" />.
        /// </summary>
        ...
        public AnimationCurveCellValue(DataTableBase dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="AnimationCurve" /> object referenced from the <see cref="DataTableBase" />.
        /// </summary>
        /// <remarks>
