...
{
    /// <summary>
    ///     A <see cref="DataTableObject" /> <see cref="long" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        /// <summary>
        ///     Creates a <see cref="LongCellValue" />.
        /// </summary>
        ...
        public LongCellValue(DataTableObject dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="long" /> value referenced from the <see cref="DataTableObject" />.
        /// </summary>
        /// <remarks>
        ...
        public long Get()
        {
            ...
            m_CachedValue = DataTable.GetInt(RowIdentifier, ColumnIdentifier);
        ...
        /// <param name="newValue">A <see cref="long" /> value.</param>
        /// <param name="updateTable">Should the value be pushed back to the referenced <see cref="DataTableObject" /> cell?</param>
        public void Set(long newValue, bool updateTable = true)
        {
            m_CachedValue = newValue;
            if (updateTable)
            {
                m_TableVersion = DataTable.SetLong(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
