...
{
    /// <summary>
    ///     A <see cref="DataTableObject" /> <see cref="Gradient" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        /// <summary>
        ///     Creates a <see cref="GradientCellValue" />.
        /// </summary>
        ...
        public GradientCellValue(DataTableObject dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="Gradient" /> object referenced from the <see cref="DataTableObject" />.
        /// </summary>
        /// <remarks>
        ...
        public Gradient Get()
        {
            ...
            m_CachedValue = DataTable.GetGradient(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(Gradient newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = DataTable.SetGradient(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
