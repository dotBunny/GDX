...
{
    /// <summary>
    ///     A <see cref="DataTableBase" /> <see cref="Gradient" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public GradientCellValue(DataTableBase dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="Gradient" /> object referenced from the <see cref="DataTableBase" />.
        /// </summary>
        /// <remarks>
