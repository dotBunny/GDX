...
{
    /// <summary>
    ///     A <see cref="DataTableObject" /> <see cref="Vector3" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public Vector3CellValue(DataTableObject dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="Vector3" /> value referenced from the <see cref="DataTableObject" />.
        /// </summary>
        /// <remarks>
