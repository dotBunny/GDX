...
{
    /// <summary>
    ///     A <see cref="DataTableObject" /> <see cref="char" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        /// <summary>
        ///     Creates a <see cref="CharCellValue" />.
        /// </summary>
        ...
        public CharCellValue(DataTableObject dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="char" /> value referenced from the <see cref="DataTableObject" />.
        /// </summary>
        /// <remarks>
        ...
        public char Get()
        {
            ...
            m_CachedValue = DataTable.GetChar(RowIdentifier, ColumnIdentifier);
        ...
        /// <param name="newValue">A <see cref="char" /> value.</param>
        /// <param name="updateTable">Should the value be pushed back to the referenced <see cref="DataTableObject" /> cell?</param>
        public void Set(char newValue, bool updateTable = true)
        {
            m_CachedValue = newValue;
            if (updateTable)
            {
                m_TableVersion = DataTable.SetChar(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
        ...
        {
            return Serializable.SerializableTypes.Char;
        }
    }
}