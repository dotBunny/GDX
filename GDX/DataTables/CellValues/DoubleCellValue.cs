...
{
    /// <summary>
    ///     A <see cref="DataTableBase" /> <see cref="double" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public DoubleCellValue(DataTableBase dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="double" /> value referenced from the <see cref="DataTableBase" />.
        /// </summary>
        /// <remarks>
