...
{
    /// <summary>
    ///     A <see cref="DataTableObject" /> <see cref="double" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        /// <summary>
        ///     Creates a <see cref="DoubleCellValue" />.
        /// </summary>
        ...
        public DoubleCellValue(DataTableObject dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="double" /> value referenced from the <see cref="DataTableObject" />.
        /// </summary>
        /// <remarks>
        ...
        public double Get()
        {
            ...
            m_CachedValue = DataTable.GetDouble(RowIdentifier, ColumnIdentifier);
        ...
        /// <param name="newValue">A <see cref="double" /> value.</param>
        /// <param name="updateTable">Should the value be pushed back to the referenced <see cref="DataTableObject" /> cell?</param>
        public void Set(double newValue, bool updateTable = true)
        {
            m_CachedValue = newValue;
            if (updateTable)
            {
                m_TableVersion = DataTable.SetDouble(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
