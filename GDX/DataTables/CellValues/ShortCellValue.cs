...
{
    /// <summary>
    ///     A <see cref="DataTableBase" /> <see cref="short" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        /// <summary>
        ///     Creates a <see cref="ShortCellValue" />.
        /// </summary>
        ...
        public ShortCellValue(DataTableBase dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="short" /> value referenced from the <see cref="DataTableBase" />.
        /// </summary>
        /// <remarks>
