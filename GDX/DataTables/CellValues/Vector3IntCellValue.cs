...
{
    /// <summary>
    ///     A <see cref="DataTableObject" /> <see cref="Vector3Int" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        /// <summary>
        ///     Creates a <see cref="Vector3IntCellValue" />.
        /// </summary>
        ...
        public Vector3IntCellValue(DataTableObject dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="Vector3Int" /> value referenced from the <see cref="DataTableObject" />.
        /// </summary>
        /// <remarks>
        ...
        public Vector3Int Get()
        {
            ...
            m_CachedValue = DataTable.GetVector3Int(RowIdentifier, ColumnIdentifier);
        ...
        /// <param name="newValue">A <see cref="Vector3Int" /> struct.</param>
        /// <param name="updateTable">Should the value be pushed back to the referenced <see cref="DataTableObject" /> cell?</param>
        public void Set(Vector3Int newValue, bool updateTable = true)
        {
            m_CachedValue = newValue;
            if (updateTable)
            {
                m_TableVersion = DataTable.SetVector3Int(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
        ...
        {
            return Serializable.SerializableTypes.Vector3Int;
        }
    }
}