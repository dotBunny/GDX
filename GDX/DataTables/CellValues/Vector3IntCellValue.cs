...
{
    /// <summary>
    ///     A <see cref="DataTableBase" /> <see cref="Vector3Int" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public Vector3IntCellValue(DataTableBase dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="Vector3Int" /> value referenced from the <see cref="DataTableBase" />.
        /// </summary>
        /// <remarks>
