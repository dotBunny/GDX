...
{
    /// <summary>
    ///     A <see cref="DataTableObject" /> <see cref="bool" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        /// <summary>
        ///     Creates a <see cref="BoolCellValue" />.
        /// </summary>
        ...
        public BoolCellValue(DataTableObject dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="bool" /> value referenced from the <see cref="DataTableObject" />.
        /// </summary>
        /// <remarks>
        ...
        public bool Get()
        {
            ...
            m_CachedValue = DataTable.GetBool(RowIdentifier, ColumnIdentifier);
        ...
        /// <param name="newValue">A <see cref="bool" /> value.</param>
        /// <param name="updateTable">Should the value be pushed back to the referenced <see cref="DataTableObject" /> cell?</param>
        public void Set(bool newValue, bool updateTable = true)
        {
            m_CachedValue = newValue;
            if (updateTable)
            {
                m_TableVersion = DataTable.SetBool(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
        ...
        {
            return Serializable.SerializableTypes.Bool;
        }
    }
}