...
{
    /// <summary>
    ///     A <see cref="DataTableObject" /> <see cref="byte" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        /// <summary>
        ///     Creates a <see cref="ByteCellValue" />.
        /// </summary>
        ...
        public ByteCellValue(DataTableObject dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="byte" /> value referenced from the <see cref="DataTableObject" />.
        /// </summary>
        /// <remarks>
        ...
        public byte Get()
        {
            ...
            m_CachedValue = DataTable.GetByte(RowIdentifier, ColumnIdentifier);
        ...
        /// <param name="newValue">A <see cref="byte" /> value.</param>
        /// <param name="updateTable">Should the value be pushed back to the referenced <see cref="DataTableObject" /> cell?</param>
        public void Set(byte newValue, bool updateTable = true)
        {
            m_CachedValue = newValue;
            if (updateTable)
            {
                m_TableVersion = DataTable.SetByte(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
        ...
        {
            return Serializable.SerializableTypes.Byte;
        }
    }
}