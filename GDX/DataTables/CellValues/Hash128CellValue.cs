...
{
    /// <summary>
    ///     A <see cref="DataTableObject" /> <see cref="Hash128" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        /// <summary>
        ///     Creates a <see cref="Hash128CellValue" />.
        /// </summary>
        ...
        public Hash128CellValue(DataTableObject dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="Hash128" /> value referenced from the <see cref="DataTableObject" />.
        /// </summary>
        /// <remarks>
        ...
        public Hash128 Get()
        {
            ...
            m_CachedValue = DataTable.GetHash128(RowIdentifier, ColumnIdentifier);
        ...
        /// <param name="newValue">A <see cref="Hash128" /> struct.</param>
        /// <param name="updateTable">Should the value be pushed back to the referenced <see cref="DataTableObject" /> cell?</param>
        public void Set(Hash128 newValue, bool updateTable = true)
        {
            m_CachedValue = newValue;
            if (updateTable)
            {
                m_TableVersion = DataTable.SetHash128(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
