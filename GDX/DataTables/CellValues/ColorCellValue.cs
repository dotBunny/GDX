...
{
    /// <summary>
    ///     A <see cref="DataTableObject" /> <see cref="Color" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        /// <summary>
        ///     Creates a <see cref="ColorCellValue" />.
        /// </summary>
        ...
        public ColorCellValue(DataTableObject dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="Color" /> value referenced from the <see cref="DataTableObject" />.
        /// </summary>
        /// <remarks>
        ...
        public Color Get()
        {
            ...
            m_CachedValue = DataTable.GetColor(RowIdentifier, ColumnIdentifier);
        ...
        /// <param name="newValue">A <see cref="Color" /> struct.</param>
        /// <param name="updateTable">Should the value be pushed back to the referenced <see cref="DataTableObject" /> cell?</param>
        public void Set(Color newValue, bool updateTable = true)
        {
            m_CachedValue = newValue;
            if (updateTable)
            {
                m_TableVersion = DataTable.SetColor(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
