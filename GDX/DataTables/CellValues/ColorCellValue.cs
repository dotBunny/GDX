...
{
    /// <summary>
    ///     A <see cref="DataTableBase" /> <see cref="Color" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public ColorCellValue(DataTableBase dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="Color" /> value referenced from the <see cref="DataTableBase" />.
        /// </summary>
        /// <remarks>
