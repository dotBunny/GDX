...
{
    /// <summary>
    ///     A <see cref="DataTableObject" /> <see cref="Bounds" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        /// <summary>
        ///     Creates a <see cref="BoundsCellValue" />.
        /// </summary>
        ...
        public BoundsCellValue(DataTableObject dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="Bounds" /> value referenced from the <see cref="DataTableObject" />.
        /// </summary>
        /// <remarks>
        ...
        public Bounds Get()
        {
            ...
            m_CachedValue = DataTable.GetBounds(RowIdentifier, ColumnIdentifier);
        ...
        /// <param name="newValue">A <see cref="Bounds" /> struct.</param>
        /// <param name="updateTable">Should the value be pushed back to the referenced <see cref="DataTableObject" /> cell?</param>
        public void Set(Bounds newValue, bool updateTable = true)
        {
            m_CachedValue = newValue;
            if (updateTable)
            {
                m_TableVersion = DataTable.SetBounds(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
        ...
        {
            return Serializable.SerializableTypes.Bounds;
        }
    }
}