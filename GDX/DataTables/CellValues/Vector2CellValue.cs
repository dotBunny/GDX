...
{
    /// <summary>
    ///     A <see cref="DataTableObject" /> <see cref="Vector2" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        /// <summary>
        ///     Creates a <see cref="Vector2CellValue" />.
        /// </summary>
        ...
        public Vector2CellValue(DataTableObject dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="Vector2" /> value referenced from the <see cref="DataTableObject" />.
        /// </summary>
        /// <remarks>
        ...
        public Vector2 Get()
        {
            ...
            m_CachedValue = DataTable.GetVector2(RowIdentifier, ColumnIdentifier);
        ...
        /// <param name="newValue">A <see cref="Vector2" /> struct.</param>
        /// <param name="updateTable">Should the value be pushed back to the referenced <see cref="DataTableObject" /> cell?</param>
        public void Set(Vector2 newValue, bool updateTable = true)
        {
            m_CachedValue = newValue;
            if (updateTable)
            {
                m_TableVersion = DataTable.SetVector2(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
        ...
        {
            return Serializable.SerializableTypes.Vector2;
        }
    }
}