...
{
    /// <summary>
    ///     A <see cref="DataTableBase" /> <see cref="LayerMask" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        /// <summary>
        ///     Creates a <see cref="LayerMaskCellValue" />.
        /// </summary>
        ...
        public LayerMaskCellValue(DataTableBase dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="LayerMask" /> value referenced from the <see cref="DataTableBase" />.
        /// </summary>
        /// <remarks>
