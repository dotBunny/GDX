...
{
    /// <summary>
    ///     A <see cref="DataTableBase" /> <see cref="string" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public StringCellValue(DataTableBase dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="string" /> value referenced from the <see cref="DataTableBase" />.
        /// </summary>
        /// <remarks>
