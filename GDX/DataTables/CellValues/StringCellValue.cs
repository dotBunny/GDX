...
{
    /// <summary>
    ///     A <see cref="DataTableObject" /> <see cref="string" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        /// <summary>
        ///     Creates a <see cref="StringCellValue" />.
        /// </summary>
        ...
        public StringCellValue(DataTableObject dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="string" /> value referenced from the <see cref="DataTableObject" />.
        /// </summary>
        /// <remarks>
        ...
        public string Get()
        {
            ...
            m_CachedValue = DataTable.GetString(RowIdentifier, ColumnIdentifier);
        ...
        /// <param name="newValue">A <see cref="string" /> value.</param>
        /// <param name="updateTable">Should the value be pushed back to the referenced <see cref="DataTableObject" /> cell?</param>
        public void Set(string newValue, bool updateTable = true)
        {
            m_CachedValue = newValue;
            if (updateTable)
            {
                m_TableVersion = DataTable.SetString(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
