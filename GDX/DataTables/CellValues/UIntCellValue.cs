...
{
    /// <summary>
    ///     A <see cref="DataTableBase" /> <see cref="uint" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public UIntCellValue(DataTableBase dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="uint" /> value referenced from the <see cref="DataTableBase" />.
        /// </summary>
        /// <remarks>
