...
{
    /// <summary>
    ///     A <see cref="DataTableObject" /> <see cref="Vector4" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        /// <summary>
        ///     Creates a <see cref="Vector4CellValue" />.
        /// </summary>
        ...
        public Vector4CellValue(DataTableObject dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="Vector4" /> value referenced from the <see cref="DataTableObject" />.
        /// </summary>
        /// <remarks>
        ...
        public Vector4 Get()
        {
            ...
            m_CachedValue = DataTable.GetVector4(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(Vector4 newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = DataTable.SetVector4(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
