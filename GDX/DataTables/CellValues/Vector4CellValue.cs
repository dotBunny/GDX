...
{
    /// <summary>
    ///     A <see cref="DataTableBase" /> <see cref="Vector4" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public Vector4CellValue(DataTableBase dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="Vector4" /> value referenced from the <see cref="DataTableBase" />.
        /// </summary>
        /// <remarks>
