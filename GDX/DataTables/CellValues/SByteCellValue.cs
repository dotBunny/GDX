...
{
    /// <summary>
    ///     A <see cref="DataTableBase" /> <see cref="sbyte" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public SByteCellValue(DataTableBase dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="sbyte" /> value referenced from the <see cref="DataTableBase" />.
        /// </summary>
        /// <remarks>
