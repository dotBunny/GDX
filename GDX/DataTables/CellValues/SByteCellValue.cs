...
{
    /// <summary>
    ///     A <see cref="DataTableObject" /> <see cref="sbyte" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        /// <summary>
        ///     Creates a <see cref="SByteCellValue" />.
        /// </summary>
        ...
        public SByteCellValue(DataTableObject dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="sbyte" /> value referenced from the <see cref="DataTableObject" />.
        /// </summary>
        /// <remarks>
        ...
        public sbyte Get()
        {
            ...
            m_CachedValue = DataTable.GetSByte(RowIdentifier, ColumnIdentifier);
        ...
        public void Set(sbyte newValue, bool updateTable = true)
        {
            ...
            if (updateTable)
            {
                m_TableVersion = DataTable.SetSByte(RowIdentifier, ColumnIdentifier, newValue);
            }
        }
