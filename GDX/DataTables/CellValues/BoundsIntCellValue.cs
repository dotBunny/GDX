...
{
    /// <summary>
    ///     A <see cref="DataTableObject" /> <see cref="BoundsInt" /> cell reference.
    /// </summary>
    [Serializable]
...
#pragma warning restore IDE1006
        ...
        public BoundsIntCellValue(DataTableObject dataTable, int rowIdentifier, int columnIdentifier)
        {
            DataTable = dataTable;
        ...
        /// <summary>
        ///     Get the <see cref="BoundsInt" /> value referenced from the <see cref="DataTableObject" />.
        /// </summary>
        /// <remarks>
