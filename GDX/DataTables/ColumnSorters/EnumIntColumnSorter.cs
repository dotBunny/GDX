...
{
    class EnumIntColumnSorter : ColumnSorterBase, IComparer<RowDescription>
    {
        /// <inheritdoc />
        public EnumIntColumnSorter(DataTableBase dataTable, int rowCount, int columnIdentifier, int sortDirection,
        ...
        {
            int lhs = DataTable.GetEnumInt(x.Identifier, ColumnIdentifier);
            int rhs = DataTable.GetEnumInt(y.Identifier, ColumnIdentifier);
