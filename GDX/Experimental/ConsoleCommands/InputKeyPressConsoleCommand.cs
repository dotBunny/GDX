...
namespace GDX.Experimental.ConsoleCommands
{
    public class InputKeyPressConsoleCommand : ConsoleCommandBase
    {
        ...
        {
            return "Synthesize the down and up event for a designated keyboard key. See https://learn.microsoft.com/en-us/windows/win32/inputdev/virtual-key-codes for valid names.";
        }
