...
using GDX.Experimental.ConsoleCommands;
...
namespace GDX.Experimental
{
    ...
    public static class DeveloperConsole
    {
        ...
        public static bool QueueCommand(string commandString)
        {
            ...
            s_CommandHistory.Add(commandString);
        ...
        static void Initialize()
        {
            ...
            if (GDX.Developer.CommandLineParser.Arguments.ContainsKey("exec"))
            {
                ...
                QueueCommand($"exec {GDX.Developer.CommandLineParser.Arguments["exec"]}");
            }
        }
    }
}