...
namespace GDX.Experimental
{
    public static class DebugDrawShapes
    {
        ...
        static void GetCircleVertices(ref Vector3[] vertices, int startIndex, Vector3 center, Quaternion rotation,
            float radius, int circleVertexCount = DefaultCircleVertexCount)
        {
            ...
            for (int i = 0; i < circleVertexCount; i++)
            {
                ...
                // Create base point
                vertices[i + startIndex] =
                    rotation * new Vector3(0, math.sin(angle) * radius, math.cos(angle) * radius) + center;
            }
        }
        ...
        static void GetCubeVerticesNonAlloc(ref Vector3[] points, int startIndex, Vector3 center, Quaternion rotation,
            Vector3 size)
        {
            Vector3 half = size / 2f;
        ...
        public static int DrawDottedCube(this DebugDrawBuffer buffer, Color color, Vector3 center, Quaternion rotation,
            Vector3 size)
        {
        ...
        public static int DrawWireCapsule(this DebugDrawBuffer buffer, Color color, Vector3 bottomSpherePosition,
            Vector3 topSpherePosition, Quaternion rotation, float radius,
            int arcVertexCount = DefaultCircleVertexCount / 2)
        {
            ...
            int bottomPrimaryStartIndex = arcVertexCount;
            ...
            for (int i = 0; i < arcVertexCount; i++)
            {
                ...
                Vector3 basePosition =
                    new Vector3(0, Mathf.Sin(currentAngle) * radius, Mathf.Cos(currentAngle) * radius);
            ...
            int secondaryTopBottomConnectionIndex = blockSize * 3 - 2;
            int secondaryBottomTopConnectionIndex = blockSize * 4 - 2;
            ...
            {
                if (i == primaryTopBottomConnectionIndex || i == primaryBottomTopConnectionIndex ||
                    i == secondaryTopBottomConnectionIndex || i == secondaryBottomTopConnectionIndex)
                {
                    baseCount++;
                    continue;
                }
            ...
            segments[primaryTopBottomConnectionIndex] = segments[primaryTopBottomConnectionIndex - 1];
            segments[primaryTopBottomConnectionIndex + 1] = segments[primaryTopBottomConnectionIndex + 2];

            segments[primaryBottomTopConnectionIndex] = segments[primaryBottomTopConnectionIndex - 1];
            segments[primaryBottomTopConnectionIndex + 1] = segments[0];

            segments[secondaryTopBottomConnectionIndex] = segments[secondaryTopBottomConnectionIndex - 1];
        ...
        public static int DrawWireArc(this DebugDrawBuffer buffer, Color color, Vector3 center, Quaternion rotation,
            float radius, float startAngle = 0f, float endAngle = 180f,
            int arcVertexCount = DefaultCircleVertexCount / 2)
        {
            ...
            for (int i = 0; i < arcVertexCount; i++)
            {
                float currentAngle = Deg2Rad * baseAngle;
                vertices[i] =
                    rotation * new Vector3(0, Mathf.Sin(currentAngle) * radius, Mathf.Cos(currentAngle) * radius) +
                    center;
                baseAngle += arcLength / lineCount;
            }
        ...
        public static int DrawWireCircle(this DebugDrawBuffer buffer, Color color, Vector3 center, Quaternion rotation,
            float radius, int circleVertexCount = DefaultCircleVertexCount)
        {
        ...
        /// <param name="size">The unit size of the cube</param>
        /// <returns>The created cube's invalidation token.</returns>
        public static int DrawWireCube(this DebugDrawBuffer buffer, Color color, Vector3 center, Quaternion rotation,
            Vector3 size)
        {
            Vector3[] vertices = GetCubeVertices(center, rotation, size);
        ...
        public static int DrawWireSphere(this DebugDrawBuffer buffer, Color color, Vector3 center, Quaternion rotation,
            float radius, int circleVertexCount = DefaultCircleVertexCount)
        {
            ...
            for (int i = 0; i < circleVertexCount; i++)
            {
                ...
                vertices[i + circleVertexCount] =
                    yRotation * new Vector3(0, math.sin(angle) * radius, math.cos(angle) * radius) + center;
            }
