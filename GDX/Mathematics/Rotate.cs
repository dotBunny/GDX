...
namespace GDX.Mathematics
{
    ...
    public static class Rotate
    {
        ...
        /// <summary>
        ///     Create a quaternion based on a rotation from <paramref name="targetQuaternion" /> to
        ///     <paramref name="otherQuaternion" />.
        /// </summary>
        ...
        public static Quaternion Towards(Quaternion targetQuaternion, Quaternion otherQuaternion, float rotationRate,
            float elapsedTime)
        {
