...
namespace GDX
{
    public static class RectExtensions
    {
        public static Rect GetCenteredRect(this Rect parentWindowPosition, Vector2 size, float safeZone = 0.9f)
        {
            ...
            float num1 = (float)((parentWindowPosition.width - (double)centeredWindowPosition.width) * 0.5);
            float num2 = (float)((parentWindowPosition.height - (double)centeredWindowPosition.height) * 0.5);
