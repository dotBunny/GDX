...
namespace GDX.Editor.PropertyDrawers.CellValues
{
    ...
    public class BoundsCellValueDrawer : CellValueDrawerBase
    {
        ...
        {
            if (Reflection.TryGetFieldValue(serializedProperty.serializedObject.targetObject, typeof(BoundsCellValue),
                    serializedProperty.name, out BoundsCellValue cell))
            {
                m_CellValue = cell;
                CopyToInspector();
            }
        ...
        protected override void CopyFromInspector(ITable table, int rowInternalIndex, int columnInternalIndex)
        {
            ...
            {
                m_CellValue = new BoundsCellValue(table, rowInternalIndex, columnInternalIndex);
            }
        }
