...
namespace GDX.Editor.PropertyDrawers.CellValues
{
    ...
    public class ULongCellValueDrawer : CellValueDrawerBase
    {
        ...
        {
            if (Reflection.TryGetFieldValue(serializedProperty.serializedObject.targetObject, typeof(ULongCellValue),
                    serializedProperty.name, out ULongCellValue cell))
            {
                m_CellValue = cell;
                CopyToInspector();
            }
        ...
        protected override void CopyFromInspector(ITable table, int rowInternalIndex, int columnInternalIndex)
        {
            ...
            {
                m_CellValue = new ULongCellValue(table, rowInternalIndex, columnInternalIndex);
            }
        }
