...
namespace GDX.Editor.PropertyDrawers.CellValues
{
    ...
    public class ObjectCellValueDrawer : CellValueDrawerBase
    {
        ...
        {
            if (Reflection.TryGetFieldValue(serializedProperty.serializedObject.targetObject, typeof(ObjectCellValue),
                    serializedProperty.name, out ObjectCellValue cell))
            {
                m_CellValue = cell;
                CopyToInspector();
            }
        ...
        protected override void CopyFromInspector(ITable table, int rowInternalIndex, int columnInternalIndex)
        {
            ...
            {
                m_CellValue = new ObjectCellValue(table, rowInternalIndex, columnInternalIndex);
            }
        }
