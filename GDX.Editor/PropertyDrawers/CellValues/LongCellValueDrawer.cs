...
namespace GDX.Editor.PropertyDrawers.CellValues
{
    ...
    public class LongCellValueDrawer : CellValueDrawerBase
    {
        ...
        {
            if (Reflection.TryGetFieldValue(serializedProperty.serializedObject.targetObject, typeof(LongCellValue),
                    serializedProperty.name, out LongCellValue cell))
            {
                m_CellValue = cell;
                CopyToInspector();
            }
        ...
        protected override void CopyFromInspector(ITable table, int rowInternalIndex, int columnInternalIndex)
        {
            ...
            {
                m_CellValue = new LongCellValue(table, rowInternalIndex, columnInternalIndex);
            }
        }
