...
namespace GDX.Editor.PropertyDrawers.CellValues
{
    ...
    public class BoolCellValueDrawer : CellValueDrawerBase
    {
        ...
        {
            m_CellValue = new BoolCellValue(m_DataTable, m_RowInternalIndex, m_ColumnInternalIndex);
        ...
        {
            Toggle cellField = (Toggle)m_CellElement;
        ...
        {
            return BoolCellValue.GetSupportedType();
        }
    }
#endif
}