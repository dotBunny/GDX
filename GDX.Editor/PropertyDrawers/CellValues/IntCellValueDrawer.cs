...
namespace GDX.Editor.PropertyDrawers.CellValues
{
    ...
    public class IntCellValueDrawer : CellValueDrawerBase
    {
        ...
        {
            if (Reflection.TryGetFieldValue(serializedProperty.serializedObject.targetObject, typeof(IntCellValue),
                    serializedProperty.name, out IntCellValue cell))
            {
                m_CellValue = cell;
                CopyToInspector();
            }
        ...
        protected override void CopyFromInspector(ITable table, int rowInternalIndex, int columnInternalIndex)
        {
            ...
            {
                m_CellValue = new IntCellValue(table, rowInternalIndex, columnInternalIndex);
            }
        }
