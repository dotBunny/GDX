...
{
    [CustomPropertyDrawer(typeof(AnimationCurveCellValue))]
    public class AnimationCurveCellValueDrawer : CellValueDrawerBase
    {
        AnimationCurveCellValue m_CellValue;
        /// <inheritdoc />
        protected override void Init(SerializedProperty serializedProperty)
        {
            if (Reflection.TryGetFieldValue(serializedProperty.serializedObject.targetObject, typeof(AnimationCurveCellValue),
                    serializedProperty.name, out AnimationCurveCellValue cell))
            {
                m_CellValue = cell;
        ...
        protected override void CreateCellValue(TableBase table, int rowInternalIndex, int columnInternalIndex)
        {
            ...
            {
                m_CellValue = new AnimationCurveCellValue(table, rowInternalIndex, columnInternalIndex);
            }
        }
        ...
        {
            return AnimationCurveCellValue.GetSupportedType();
        }
    }
}