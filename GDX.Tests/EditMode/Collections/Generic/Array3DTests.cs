...
{
    /// <summary>
    ///     A collection of unit tests to validate functionality of the <see cref="Array3D{T}" />.
    /// </summary>
    public class Array3DTests
    {
        ...
        Array3D<int> m_MockArray;

        [SetUp]
        public void Setup()
        {
            m_MockArray = new Array3D<int>(k_TargetWidth, k_TargetHeight, k_TargetDepth);
        }
