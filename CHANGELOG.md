...
- Additional information around naming conventions and [design guidelines](https://gdx.dotbunny.com/manual/contributing/design-guideliness.html) to documentation.
